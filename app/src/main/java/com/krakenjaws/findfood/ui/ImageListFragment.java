...
import com.krakenjaws.findfood.adapters.ImageListRecyclerAdapter;
...
public class ImageListFragment extends Fragment implements
    ...
    /**
     * Right now these are example profile images
     */
    ...
    private void initRecyclerview() {
        ImageListRecyclerAdapter mAdapter = new ImageListRecyclerAdapter(
                getActivity(), mImageResources, this);
